...
public class TheAbyssBiomeBiome {
	public static Biome createBiome() {
		BiomeSpecialEffects effects = new BiomeSpecialEffects.Builder().fogColor(-10927293).waterColor(-13685699).waterFogColor(-13750983)
				.skyColor(-10927293).foliageColorOverride(-12517360).grassColorOverride(-11599857)
				.ambientLoopSound(new SoundEvent(new ResourceLocation("kyomod:harmonious"))).build();
		BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder();
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION,
				PlacementUtils.register("kyomod:tree_the_abyss_biome",
						FeatureUtils.register("kyomod:tree_the_abyss_biome", Feature.TREE,
								new TreeConfiguration.TreeConfigurationBuilder(
										BlockStateProvider.simple(KyomodModBlocks.BLIGHTED_WOOD_LOG.get().defaultBlockState()),
						...
						List.of(CountPlacement.of(1), InSquarePlacement.spread(), SurfaceWaterDepthFilter.forMaxDepth(0),
								...
								BiomeFilter.biome())));
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION,
				PlacementUtils.register("kyomod:grass_the_abyss_biome", VegetationFeatures.PATCH_GRASS,
		...
		return new Biome.BiomeBuilder().precipitation(Biome.Precipitation.RAIN).temperature(0.3f).downfall(0.4f).specialEffects(effects)
