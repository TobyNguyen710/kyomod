...
public class GeneratorGUIScreen extends AbstractContainerScreen<GeneratorGUIMenu> {
	...
	private static final ResourceLocation texture = new ResourceLocation("kyomod:textures/screens/generator_gui.png");
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, "Generator", 6, 7, -12829636);
		...
		}.getValue(new BlockPos((int) x, (int) y, (int) z), "progress")) + "%", 6, 38, -12829636);
	}
