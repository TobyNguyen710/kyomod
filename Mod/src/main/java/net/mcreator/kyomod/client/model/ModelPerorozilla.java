...
public class ModelPerorozilla<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("kyomod", "model_perorozilla"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bb_main = partdefinition.addOrReplaceChild("bb_main",
				CubeListBuilder.create().texOffs(0, 620).addBox(-110.0F, -179.0F, -94.0F, 220.0F, 80.0F, 220.0F, new CubeDeformation(0.0F))
						.texOffs(0, 0).addBox(-120.0F, -110.0F, -104.0F, 240.0F, 80.0F, 240.0F, new CubeDeformation(0.0F)).texOffs(680, 420)
