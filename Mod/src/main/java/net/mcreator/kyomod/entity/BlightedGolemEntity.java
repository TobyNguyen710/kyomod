...
public class BlightedGolemEntity extends Monster {
	...
	public BlightedGolemEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(KyomodModEntities.BLIGHTED_GOLEM.get(), world);
	}

	public BlightedGolemEntity(EntityType<BlightedGolemEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
