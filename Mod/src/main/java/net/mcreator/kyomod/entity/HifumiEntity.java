...
import net.mcreator.kyomod.procedures.HifumiOnInitialEntitySpawnProcedure;
...
public class HifumiEntity extends TamableAnimal implements RangedAttackMob {
	public HifumiEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(KyomodModEntities.HIFUMI.get(), world);
	}

	public HifumiEntity(EntityType<HifumiEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	public SoundEvent getAmbientSound() {
		return ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("kyomod:hifumi_sensei"));
	}
	...
	public SpawnGroupData finalizeSpawn(ServerLevelAccessor world, DifficultyInstance difficulty, MobSpawnType reason,
		...
		HifumiOnInitialEntitySpawnProcedure.execute(this);
		return retval;
	}
	...
	public void performRangedAttack(LivingEntity target, float flval) {
		HifumiBulletEntity.shoot(this, target);
	}

	@Override
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		HifumiEntity retval = KyomodModEntities.HIFUMI.get().create(serverWorld);
	...
	public boolean isFood(ItemStack stack) {
		return List.of(KyomodModItems.HALO.get()).contains(stack.getItem());
	}

	public static void init() {
		SpawnPlacements.register(KyomodModEntities.HIFUMI.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
