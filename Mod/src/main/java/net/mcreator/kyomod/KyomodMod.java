...
import net.mcreator.kyomod.init.KyomodModSounds;
...
@Mod("kyomod")
public class KyomodMod {
	public static final Logger LOGGER = LogManager.getLogger(KyomodMod.class);
	public static final String MODID = "kyomod";

	public KyomodMod() {
		MinecraftForge.EVENT_BUS.register(this);
		KyomodModTabs.load();
		IEventBus bus = FMLJavaModLoadingContext.get().getModEventBus();
		KyomodModSounds.REGISTRY.register(bus);
		KyomodModBlocks.REGISTRY.register(bus);
		KyomodModItems.REGISTRY.register(bus);
		KyomodModEntities.REGISTRY.register(bus);
		KyomodModBlockEntities.REGISTRY.register(bus);
		KyomodModFeatures.REGISTRY.register(bus);
