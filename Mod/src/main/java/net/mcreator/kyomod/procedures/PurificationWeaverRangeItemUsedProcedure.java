...
public class PurificationWeaverRangeItemUsedProcedure {
		...
		if ((entity instanceof Player _plr ? _plr.getAbilities().instabuild : false)
			...
			if (world instanceof Level _level) {
				if (!_level.isClientSide()) {
					_level.playSound(null, new BlockPos(x, y, z), ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("kyomod:sfx_ar")),
							SoundSource.PLAYERS, 1, (float) 1.5);
				} else {
					_level.playLocalSound(x, y, z, ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("kyomod:sfx_ar")), SoundSource.PLAYERS,
							1, (float) 1.5, false);
				}
			}
			{
